...
/**
 * Page Object for Conductor Dashboard
 */
public class ConductorDashboardPage extends BasePage {
    ...
    public ConductorDashboardPage(WebDriver driver) {
        super(driver);
    }

    public boolean isConductorDashboardDisplayed() {
        try {
            Thread.sleep(2000);
            String currentUrl = driver.getCurrentUrl();
            return currentUrl.contains("/conductor") || currentUrl.contains("/dashboard");
        } catch (Exception e) {
            return false;
        }
    }
