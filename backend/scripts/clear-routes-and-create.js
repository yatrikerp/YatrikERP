...
// Clear routes and create new ones
const clearAndCreateRoutes = async () => {
  try {
    ...
    console.log('✅ Successfully created route:', newRoute.routeNumber);
