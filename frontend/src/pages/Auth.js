...
const Auth = ({ initialMode = 'login' }) => {
  ...
  const validateSignupForm = useCallback(() => {
    ...
    } else if (!/^[\+]?[1-9][\d]{0,15}$/.test(signupForm.phone.trim().replace(/\s/g, ''))) {
      ...
      <div className="fade-in">
        ...
        <div className="mb-6 grid grid-cols-2 rounded-lg border border-gray-200 overflow-hidden">
          <button 
            type="button" 
            onClick={() => setMode('login')} 
            className={`py-2.5 text-sm font-medium transition-all duration-200 ${
              isLogin ? 'bg-primary-50 text-primary-700' : 'bg-white text-neutral-600 hover:bg-gray-50'
            }`}
            disabled={isLoggingIn || isSigningUp}
          >
            Sign in
          ...
          <div>
            <form className="space-y-6 login-form-compact" onSubmit={onSubmitLogin}>
              ...
              <div>
                <button 
                  type="submit" 
                  className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-200 btn-transition login-form-compact"
                  disabled={isLoggingIn}
                >
                  {isLoggingIn ? (
            ...
            <div className="max-w-lg mx-auto">
              <form className="space-y-2 login-form-compact" onSubmit={onSubmitSignup}>
                ...
                <div>
                  <button 
                    type="submit" 
                    className="w-full flex justify-center py-1.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-200 btn-transition login-form-compact"
                    disabled={isSigningUp}
                  >
                    {isSigningUp ? (
                      <div className="flex items-center space-x-2">
