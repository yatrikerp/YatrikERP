...
const DepotDashboard = () => {
  ...
  const renderManagementComponent = () => {
    ...
    switch (currentSection) {
      case 'fleet':
        return <React.Suspense fallback={fallback}><FleetManagement /></React.Suspense>;
      case 'routes':
        return <React.Suspense fallback={fallback}><RouteManagement /></React.Suspense>;
      case 'trips':
        return <React.Suspense fallback={fallback}><TripManagement /></React.Suspense>;
      case 'bookings':
        return <React.Suspense fallback={fallback}><BookingManagement /></React.Suspense>;
      case 'staff':
        return <React.Suspense fallback={fallback}><StaffManagement /></React.Suspense>;
      case 'scheduling':
        return <React.Suspense fallback={fallback}><BusScheduling /></React.Suspense>;
      case 'reports':
        return <React.Suspense fallback={fallback}><ReportsAnalytics /></React.Suspense>;
      default:
        return null;
    }
  };
