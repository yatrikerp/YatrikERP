    ...
    const mockTrips = [
      {
        ...
        waypoints: [
          { name: 'Thane', time: '06:45', status: 'completed' },
          { name: 'Kalyan', time: '07:30', status: 'completed' },
          { name: 'Lonavala', time: '08:45', status: 'in-progress' },
          { name: 'Pune Station', time: '09:30', status: 'pending' }
        ]
      },
      {
        id: 'T002',
        route: 'Mumbai-Nashik Highway',
        routeCode: 'MNH-002',
        bus: 'MH-12-CD-5678',
        driver: 'Vikram Mehta',
        ...
        assignedDate: '2024-01-15',
        priority: 'medium',
        notes: 'Highway route with scenic views',
        waypoints: [
          { name: 'Thane', time: '08:15', status: 'pending' },
          { name: 'Bhiwandi', time: '09:00', status: 'pending' },
          { name: 'Kalyan', time: '09:45', status: 'pending' },
          { name: 'Igatpuri', time: '11:00', status: 'pending' },
          { name: 'Nashik Central', time: '11:45', status: 'pending' }
        ]
      },
      {
        id: 'T003',
        ...
        status: 'completed',
        startLocation: 'Mumbai Central',
        endLocation: 'Aurangabad Station',
        distance: '330 km',
        duration: '7h 45m',
        passengers: 45,
        capacity: 45,
        ...
        waypoints: [
          { name: 'Thane', time: '08:45', status: 'completed' },
          { name: 'Nashik', time: '11:00', status: 'completed' },
          { name: 'Aurangabad Station', time: '15:45', status: 'completed' }
        ]
      }
    ];
