...
import { Bus, Link, MapPin, Calendar, Search, Clock, Navigation, ArrowRight } from 'lucide-react';
import { toast } from 'react-hot-toast';
import './RedBusSearchCard.css';

const RedBusSearchCard = ({ onSearchResults, showResults = false }) => {
  ...
  return (
    <div className="redbus-search-card">
      ...
      <div className="search-tabs">
        ...
        >
          <Bus className="tab-icon" />
          <span>Book Bus Ticket</span>
        </button>
        <button
          onClick={() => setActiveTab('link')}
          className={`search-tab ${activeTab === 'link' ? 'active' : ''}`}
        >
...
export default RedBusSearchCard;
