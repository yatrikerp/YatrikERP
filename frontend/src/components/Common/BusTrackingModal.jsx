  ...
  const sampleTrips = [
    {
      ...
      routeId: {
        ...
        endingPoint: { city: 'Thiruvananthapuram', location: 'Central Bus Station' }
      },
      busId: {
                ...
                {selectedTrip ? (
                  <>
                    ...
                    <div className="h-2/3 relative">
                      <div className="w-full h-full bg-gray-100 rounded-lg m-4 overflow-hidden">
                        {isMapsApiConfigured() && generateGoogleMapsUrl(selectedTrip) ? (
                          <iframe
                            src={generateGoogleMapsUrl(selectedTrip)}
                          ...
                          <div className="w-full h-full bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
                            <div className="text-center max-w-md mx-auto p-6">
                              ...
                              {!isMapsApiConfigured() && (
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                                  ...
                                  <p className="text-xs text-yellow-700 mb-2">
                                    To enable Google Maps integration, add your API key to the environment variables.
                                  </p>
                                  <a
                              ...
                              <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
                                ...
                                <p className="text-sm text-gray-600">{selectedTrip.currentLocation}</p>
                                <p className="text-xs text-gray-500 mt-1">
                                  Coordinates: {selectedTrip.coordinates.lat.toFixed(4)}, {selectedTrip.coordinates.lng.toFixed(4)}
                                </p>
                                <button
                                  onClick={() => window.open(`https://www.google.com/maps?q=${selectedTrip.coordinates.lat},${selectedTrip.coordinates.lng}`, '_blank')}
                      ...
                      {/* Map Overlay Info */}
                      <div className="absolute top-6 left-6 bg-white rounded-lg p-3 shadow-lg border border-gray-200">
